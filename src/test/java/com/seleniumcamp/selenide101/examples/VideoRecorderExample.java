...
public class VideoRecorderExample {
  ...
  //video is only saved, if the test failing
  @Video
  @Test
  public void checkboxTest() {
    ...
    $("[type=checkbox]").click();
    $("[type=checkbox]").shouldBe(checked);

    $("[type=checkbox]").setSelected(true);
    $("[type=checkbox]").shouldNotBe(checked); //this should fail


    $("[type=checkbox]", 1).setSelected(false);
